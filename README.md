...
The script now tests for webp support and if it exists uses webp images. Edited to work with: [Jekyll Picture Tag](https://github.com/benjamincharity/jekyll-picture-tag).
